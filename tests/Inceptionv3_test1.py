...
class Inceptionv3():
    def __init__(self, num_step, type, batch_size, gpu_num, file_name):
        ...
        self.f1 = open('./log/' + 'type' + str(type) + '_DenseNet_' + file_name + '_record_1.txt', 'w')
        self.f3 = open('./log/' + 'type' + str(type) + '_DenseNet_' + file_name + '_record_3.txt', 'w')
        self.f6 = open('./log/' + 'type' + str(type) + '_DenseNet_' + file_name + '_record_6.txt', 'w')
        self.f7 = open('./log/' + 'type' + str(type) + '_DenseNet_' + file_name + '_record_7.txt', 'w')
        self.type = type
        if type == 0:
    ...
    #inception前
        covb_1=self.ad.convolution_2d_forward_op(X, filterb_1, "NCHW", "VALID", 2, 2)
        covb_2=self.ad.convolution_2d_forward_op(covb_1, filterb_2, "NCHW", "VALID", 1, 1)
        covb_3= self.ad.convolution_2d_forward_op(covb_2, filterb_3, "NCHW", "SAME", 1, 1)
        poolb= self.ad.pooling_2d_forward_op(covb_3,"NCHW", "max", 0, 0, 2, 2, 3, 3)
        covb_4 = self.ad.convolution_2d_forward_op(poolb, filterb_4, "NCHW", "VALID", 1, 1)
        covb_5 = self.ad.convolution_2d_forward_op(covb_4, filterb_5, "NCHW", "VALID", 1, 1)
    ...
    # inception_moudle1
     #inception_moudle1_1
        ...
        # branch_0
        incep1_1_0=self.ad.convolution_2d_forward_op(covb, filter1_1_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep1_1_1a=self.ad.convolution_2d_forward_op(covb, filter1_1_1a, "NCHW", "SAME", 1, 1)
        incep1_1_1 = self.ad.convolution_2d_forward_op(incep1_1_1a, filter1_1_1b, "NCHW", "SAME", 1, 1)
        # branch 2
        incep1_1_2a = self.ad.convolution_2d_forward_op(covb, filter1_1_2a, "NCHW", "SAME", 1, 1)
        incep1_1_2b = self.ad.convolution_2d_forward_op(incep1_1_2a, filter1_1_2b, "NCHW", "SAME", 1, 1)
        incep1_1_2 = self.ad.convolution_2d_forward_op(incep1_1_2b, filter1_1_2c, "NCHW", "SAME", 1, 1)
        # branch 3
        incep1_1_3a = self.ad.pooling_2d_forward_op(covb,"NCHW", "mean", 1, 1, 1, 1, 3, 3)
        incep1_1_3 = self.ad.convolution_2d_forward_op(incep1_1_3a, filter1_1_3, "NCHW", "SAME", 1, 1)
     ...
     #inception_moudle1_2
        ...
        # branch_0
        incep1_2_0 = self.ad.convolution_2d_forward_op(concat1_1, filter1_2_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep1_2_1a = self.ad.convolution_2d_forward_op(concat1_1, filter1_2_1a, "NCHW", "SAME", 1, 1)
        incep1_2_1 = self.ad.convolution_2d_forward_op(incep1_2_1a, filter1_2_1b, "NCHW", "SAME", 1, 1)
        # branch 2
        incep1_2_2a = self.ad.convolution_2d_forward_op(concat1_1, filter1_2_2a, "NCHW", "SAME", 1, 1)
        incep1_2_2b = self.ad.convolution_2d_forward_op(incep1_2_2a, filter1_2_2b, "NCHW", "SAME", 1, 1)
        incep1_2_2 = self.ad.convolution_2d_forward_op(incep1_2_2b, filter1_2_2c, "NCHW", "SAME", 1, 1)
        # branch 3
        incep1_2_3a = self.ad.pooling_2d_forward_op(concat1_1, "NCHW", "mean", 1, 1, 1, 1, 3, 3)
        incep1_2_3 = self.ad.convolution_2d_forward_op(incep1_2_3a, filter1_2_3, "NCHW", "SAME", 1, 1)
     ...
     # inception_moudle1_3
        ...
        # branch_0
        incep1_3_0 = self.ad.convolution_2d_forward_op(concat1_2, filter1_3_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep1_3_1a = self.ad.convolution_2d_forward_op(concat1_2, filter1_3_1a, "NCHW", "SAME", 1, 1)
        incep1_3_1 = self.ad.convolution_2d_forward_op(incep1_3_1a, filter1_3_1b, "NCHW", "SAME", 1, 1)
        # branch 2
        incep1_3_2a = self.ad.convolution_2d_forward_op(concat1_2, filter1_3_2a, "NCHW", "SAME", 1, 1)
        incep1_3_2b = self.ad.convolution_2d_forward_op(incep1_3_2a, filter1_3_2b, "NCHW", "SAME", 1, 1)
        incep1_3_2 = self.ad.convolution_2d_forward_op(incep1_3_2b, filter1_3_2c, "NCHW", "SAME", 1, 1)
        # branch 3
        incep1_3_3a = self.ad.pooling_2d_forward_op(concat1_2, "NCHW", "mean", 1, 1, 1, 1, 3, 3)
        incep1_3_3 = self.ad.convolution_2d_forward_op(incep1_3_3a, filter1_3_3, "NCHW", "SAME", 1, 1)
    ...
    # # inception_moudle2
        ...
        # branch_0
        incep2_1_0 = self.ad.convolution_2d_forward_op(concat1_3, filter2_1_0, "NCHW", "VALID", 2, 2)
        # branch 1
        incep2_1_1a = self.ad.convolution_2d_forward_op(concat1_3, filter2_1_1a, "NCHW", "SAME", 1, 1)
        incep2_1_1b = self.ad.convolution_2d_forward_op(incep2_1_1a, filter2_1_1b, "NCHW", "SAME", 1, 1)
        incep2_1_1 = self.ad.convolution_2d_forward_op(incep2_1_1b, filter2_1_1c, "NCHW", "VALID", 2,2)
        # branch 2
      ...
      # inception_moudle2_2
        ...
        # branch_0
        incep2_2_0 = self.ad.convolution_2d_forward_op(concat2_1, filter2_2_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep2_2_1a = self.ad.convolution_2d_forward_op(concat2_1, filter2_2_1a, "NCHW", "SAME", 1, 1)
        incep2_2_1b = self.ad.convolution_2d_forward_op(incep2_2_1a, filter2_2_1b, "NCHW", "SAME", 1, 1)
        incep2_2_1 = self.ad.convolution_2d_forward_op(incep2_2_1b, filter2_2_1c, "NCHW", "SAME", 1, 1)
        # branch 2
        incep2_2_2a = self.ad.convolution_2d_forward_op(concat2_1, filter2_2_2a, "NCHW", "SAME", 1, 1)
        incep2_2_2b = self.ad.convolution_2d_forward_op(incep2_2_2a, filter2_2_2b, "NCHW", "SAME", 1, 1)
        incep2_2_2c = self.ad.convolution_2d_forward_op(incep2_2_2b, filter2_2_2c, "NCHW", "SAME", 1, 1)
        incep2_2_2d = self.ad.convolution_2d_forward_op(incep2_2_2c, filter2_2_2d, "NCHW", "SAME", 1, 1)
        incep2_2_2 = self.ad.convolution_2d_forward_op(incep2_2_2d, filter2_2_2e, "NCHW", "SAME", 1, 1)
        # branch 3
        incep2_2_3a = self.ad.pooling_2d_forward_op(concat2_1, "NCHW", "mean", 1, 1, 1, 1, 3, 3)
        incep2_2_3 = self.ad.convolution_2d_forward_op(incep2_2_3a, filter2_2_3, "NCHW", "SAME", 1, 1)
    ...
    # inception_moudle2_3
        ...
        # branch_0
        incep2_3_0 = self.ad.convolution_2d_forward_op(concat2_2, filter2_3_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep2_3_1a = self.ad.convolution_2d_forward_op(concat2_2, filter2_3_1a, "NCHW", "SAME", 1, 1)
        incep2_3_1b = self.ad.convolution_2d_forward_op(incep2_3_1a, filter2_3_1b, "NCHW", "SAME", 1, 1)
        incep2_3_1 = self.ad.convolution_2d_forward_op(incep2_3_1b, filter2_3_1c, "NCHW", "SAME", 1, 1)
        # branch 2
        incep2_3_2a = self.ad.convolution_2d_forward_op(concat2_2, filter2_3_2a, "NCHW", "SAME", 1, 1)
        incep2_3_2b = self.ad.convolution_2d_forward_op(incep2_3_2a, filter2_3_2b, "NCHW", "SAME", 1, 1)
        incep2_3_2c = self.ad.convolution_2d_forward_op(incep2_3_2b, filter2_3_2c, "NCHW", "SAME", 1, 1)
        incep2_3_2d = self.ad.convolution_2d_forward_op(incep2_3_2c, filter2_3_2d, "NCHW", "SAME", 1, 1)
        incep2_3_2 = self.ad.convolution_2d_forward_op(incep2_3_2d, filter2_3_2e, "NCHW", "SAME", 1, 1)
        # branch 3
        incep2_3_3a = self.ad.pooling_2d_forward_op(concat2_2, "NCHW", "mean", 1, 1, 1, 1, 3, 3)
        incep2_3_3 = self.ad.convolution_2d_forward_op(incep2_3_3a, filter2_3_3, "NCHW", "SAME", 1, 1)
     ...
     # inception_moudle2_4
        ...
        # branch_0
        incep2_4_0 = self.ad.convolution_2d_forward_op(concat2_3, filter2_4_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep2_4_1a = self.ad.convolution_2d_forward_op(concat2_3, filter2_4_1a, "NCHW", "SAME", 1, 1)
        incep2_4_1b = self.ad.convolution_2d_forward_op(incep2_4_1a, filter2_4_1b, "NCHW", "SAME", 1, 1)
        incep2_4_1 = self.ad.convolution_2d_forward_op(incep2_4_1b, filter2_4_1c, "NCHW", "SAME", 1, 1)
        # branch 2
        incep2_4_2a = self.ad.convolution_2d_forward_op(concat2_3, filter2_4_2a, "NCHW", "SAME", 1, 1)
        incep2_4_2b = self.ad.convolution_2d_forward_op(incep2_4_2a, filter2_4_2b, "NCHW", "SAME", 1, 1)
        incep2_4_2c = self.ad.convolution_2d_forward_op(incep2_4_2b, filter2_4_2c, "NCHW", "SAME", 1, 1)
        incep2_4_2d = self.ad.convolution_2d_forward_op(incep2_4_2c, filter2_4_2d, "NCHW", "SAME", 1, 1)
        incep2_4_2 = self.ad.convolution_2d_forward_op(incep2_4_2d, filter2_4_2e, "NCHW", "SAME", 1, 1)
        # branch 3
        incep2_4_3a = self.ad.pooling_2d_forward_op(concat2_3, "NCHW", "mean", 1, 1, 1, 1, 3, 3)
        incep2_4_3 = self.ad.convolution_2d_forward_op(incep2_4_3a, filter2_4_3, "NCHW", "SAME", 1, 1)
    ...
    # inception_moudle2_5
        ...
        # branch_0
        incep2_5_0 = self.ad.convolution_2d_forward_op(concat2_4, filter2_5_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep2_5_1a = self.ad.convolution_2d_forward_op(concat2_4, filter2_5_1a, "NCHW", "SAME", 1, 1)
        incep2_5_1b = self.ad.convolution_2d_forward_op(incep2_5_1a, filter2_5_1b, "NCHW", "SAME", 1, 1)
        incep2_5_1 = self.ad.convolution_2d_forward_op(incep2_5_1b, filter2_5_1c, "NCHW", "SAME", 1, 1)
        # branch 2
        incep2_5_2a = self.ad.convolution_2d_forward_op(concat2_4, filter2_5_2a, "NCHW", "SAME", 1, 1)
        incep2_5_2b = self.ad.convolution_2d_forward_op(incep2_5_2a, filter2_5_2b, "NCHW", "SAME", 1, 1)
        incep2_5_2c = self.ad.convolution_2d_forward_op(incep2_5_2b, filter2_5_2c, "NCHW", "SAME", 1, 1)
        incep2_5_2d = self.ad.convolution_2d_forward_op(incep2_5_2c, filter2_5_2d, "NCHW", "SAME", 1, 1)
        incep2_5_2 = self.ad.convolution_2d_forward_op(incep2_5_2d, filter2_5_2e, "NCHW", "SAME", 1, 1)
        # branch 3
        incep2_5_3a = self.ad.pooling_2d_forward_op(concat2_4, "NCHW", "mean", 1, 1, 1, 1, 3, 3)
        incep2_5_3 = self.ad.convolution_2d_forward_op(incep2_5_3a, filter2_5_3, "NCHW", "SAME", 1, 1)
    ...
    # # inception_moudle3
        ...
        # branch_0
        incep3_1_0a = self.ad.convolution_2d_forward_op(concat2_2, filter3_1_0a, "NCHW", "SAME", 1, 1)
        incep3_1_0 = self.ad.convolution_2d_forward_op(incep3_1_0a, filter3_1_0b, "NCHW", "VALID", 2,2)
        # branch 1
        incep3_1_1a = self.ad.convolution_2d_forward_op(concat2_2, filter3_1_1a, "NCHW", "SAME", 1, 1)
        incep3_1_1b = self.ad.convolution_2d_forward_op(incep3_1_1a, filter3_1_1b, "NCHW", "SAME", 1, 1)
        incep3_1_1c = self.ad.convolution_2d_forward_op(incep3_1_1b, filter3_1_1c, "NCHW", "SAME", 1, 1)
        incep3_1_1 = self.ad.convolution_2d_forward_op(incep3_1_1c, filter3_1_1d, "NCHW", "VALID", 2, 2)
        # branch 2
    ...
    # inception_moudle3_2
        ...
        # branch_0
        incep3_2_0 = self.ad.convolution_2d_forward_op(concat3_1, filter3_2_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep3_2_1a = self.ad.convolution_2d_forward_op(concat3_1, filter3_2_1a, "NCHW", "SAME", 1, 1)
        incep3_2_1b = self.ad.convolution_2d_forward_op(incep3_2_1a, filter3_2_1b, "NCHW", "SAME", 1, 1)
        incep3_2_1c = self.ad.convolution_2d_forward_op(incep3_2_1a, filter3_2_1c, "NCHW", "SAME", 1, 1)
        incep3_2_1=self.ad.concat_forward_op(incep3_2_1b, incep3_2_1c)
        # branch 2
        incep3_2_2a = self.ad.convolution_2d_forward_op(concat3_1, filter3_2_2a, "NCHW", "SAME", 1, 1)
        incep3_2_2b = self.ad.convolution_2d_forward_op(incep3_2_2a, filter3_2_2b, "NCHW", "SAME", 1, 1)
        incep3_2_2c = self.ad.convolution_2d_forward_op(incep3_2_2b, filter3_2_2c, "NCHW", "SAME", 1, 1)
        incep3_2_2d = self.ad.convolution_2d_forward_op(incep3_2_2b, filter3_2_2d, "NCHW", "SAME", 1, 1)
        ...
        incep3_2_3 = self.ad.convolution_2d_forward_op(incep3_2_3a, filter3_2_3, "NCHW", "SAME", 1, 1)
    ...
    # # inception_moudle3_3
        ...
        # branch_0
        incep3_3_0 = self.ad.convolution_2d_forward_op(concat3_2, filter3_3_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep3_3_1a = self.ad.convolution_2d_forward_op(concat3_2, filter3_3_1a, "NCHW", "SAME", 1, 1)
        incep3_3_1b = self.ad.convolution_2d_forward_op(incep3_3_1a, filter3_3_1b, "NCHW", "SAME", 1, 1)
        incep3_3_1c = self.ad.convolution_2d_forward_op(incep3_3_1a, filter3_3_1c, "NCHW", "SAME", 1, 1)
        incep3_3_1 = self.ad.concat_forward_op(incep3_3_1b, incep3_3_1c)

        # branch 2
        incep3_3_2a = self.ad.convolution_2d_forward_op(concat3_2, filter3_3_2a, "NCHW", "SAME", 1, 1)
        incep3_3_2b = self.ad.convolution_2d_forward_op(incep3_3_2a, filter3_3_2b, "NCHW", "SAME", 1, 1)
        incep3_3_2c = self.ad.convolution_2d_forward_op(incep3_3_2b, filter3_3_2c, "NCHW", "SAME", 1, 1)
        incep3_3_2d = self.ad.convolution_2d_forward_op(incep3_3_2b, filter3_3_2d, "NCHW", "SAME", 1, 1)
        ...
        incep3_3_3 = self.ad.convolution_2d_forward_op(incep3_3_3a, filter3_3_3, "NCHW", "SAME", 1, 1)
        ...
        convlast=self.ad.convolution_2d_forward_op(dropout, filtera1, "NCHW", "SAME", 1, 1)
...
def run(num_step, type, batch_size, gpu_num, file_name):
        record = record_GPU.record("InceptionV3", type, gpu_num, file_name)
        record.start()
        print("InceptionV3" + " type" + str(type) + " start")
        inception_v3 = Inceptionv3(num_step, type, batch_size, gpu_num, file_name)
        inception_v3.inception_v3()
        print("InceptionV3" + " type" + str(type) + " finish")
        record.stop()
