...
class Inceptionv4():
    ...
    def block_inception_a(self,inputs,blockname=None):
        ...
        # branch_0
        incep1_1_0 = self.ad.convolution_2d_forward_op(inputs, filter1_1_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep1_1_1a = self.ad.convolution_2d_forward_op(inputs, filter1_1_1a, "NCHW", "SAME", 1, 1)
        incep1_1_1 = self.ad.convolution_2d_forward_op(incep1_1_1a, filter1_1_1b, "NCHW", "SAME", 1, 1)
        # branch 2
        incep1_1_2a = self.ad.convolution_2d_forward_op(inputs, filter1_1_2a, "NCHW", "SAME", 1, 1)
    ...
    def block_reduction_a(self,inputs,input_size,blockname=None):
        ...
        # branch_0
        incep2_1_0 = self.ad.convolution_2d_forward_op(inputs, filter2_1_0, "NCHW", "VALID", 2, 2)
        # branch 1
        incep2_1_1a = self.ad.convolution_2d_forward_op(inputs, filter2_1_1a, "NCHW", "SAME", 1, 1)
    ...
    def block_inception_b(self,inputs,input_size,blockname=None):
        ...
        # branch_0
        incep2_2_0 = self.ad.convolution_2d_forward_op(inputs, filter2_2_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep2_2_1a = self.ad.convolution_2d_forward_op(inputs, filter2_2_1a, "NCHW", "SAME", 1, 1)
        ...
        # branch 2
        incep2_2_2a = self.ad.convolution_2d_forward_op(inputs, filter2_2_2a, "NCHW", "SAME", 1, 1)
    ...
    def block_reduction_b(self,inputs,input_size,blockname=None):
        ...
        # branch_0
        incep3_1_0a = self.ad.convolution_2d_forward_op(inputs, filter3_1_0a, "NCHW", "SAME", 1, 1)
        incep3_1_0 = self.ad.convolution_2d_forward_op(incep3_1_0a, filter3_1_0b, "NCHW", "VALID", 2, 2)
        # branch 1
        incep3_1_1a = self.ad.convolution_2d_forward_op(inputs, filter3_1_1a, "NCHW", "SAME", 1, 1)
    ...
    def block_inception_c(self,inputs,input_size,blockname=None):
        ...
        # branch_0
        incep3_2_0 = self.ad.convolution_2d_forward_op(inputs, filter3_2_0, "NCHW", "SAME", 1, 1)
        # branch 1
        incep3_2_1a = self.ad.convolution_2d_forward_op(inputs, filter3_2_1a, "NCHW", "SAME", 1, 1)
        ...
        # branch 2
        incep3_2_2a = self.ad.convolution_2d_forward_op(inputs, filter3_2_2a, "NCHW", "SAME", 1, 1)
        ...
        incep3_2_2d = self.ad.convolution_2d_forward_op(incep3_2_2c, filter3_2_2d, "NCHW", "SAME", 1, 1)
        incep3_2_2e = self.ad.convolution_2d_forward_op(incep3_2_2c, filter3_2_2e, "NCHW", "SAME", 1, 1)
    ...
    # stem
        cov1=self.ad.convolution_2d_forward_op(X, f1, "NCHW", "VALID", 2, 2)
        cov2=self.ad.convolution_2d_forward_op(cov1, f2, "NCHW", "VALID", 1, 1)
        cov3= self.ad.convolution_2d_forward_op(cov2, f3, "NCHW", "SAME", 1, 1)
        pool4= self.ad.pooling_2d_forward_op(cov3, "NCHW", "max", 0, 0, 2, 2, 3, 3)
        cov4 = self.ad.convolution_2d_forward_op(cov3, f4, "NCHW", "VALID", 2, 2)
        concat1=self.ad.concat_forward_op(pool4,cov4)
        cov5_1=self.ad.convolution_2d_forward_op(concat1, f5_1, "NCHW", "SAME", 1, 1)
        cov5_2= self.ad.convolution_2d_forward_op(cov5_1, f5_2, "NCHW", "VALID", 1, 1)
        cov6_1 = self.ad.convolution_2d_forward_op(concat1, f6_1, "NCHW", "SAME", 1, 1)
        cov6_2= self.ad.convolution_2d_forward_op(cov6_1, f6_2, "NCHW", "SAME", 1, 1)
        cov6_3 = self.ad.convolution_2d_forward_op(cov6_2, f6_3, "NCHW", "SAME", 1, 1)
        cov6_4 = self.ad.convolution_2d_forward_op(cov6_3, f6_4, "NCHW", "VALID", 1, 1)
        concat2=self.ad.concat_forward_op(cov5_2,cov6_4)
        cov7= self.ad.convolution_2d_forward_op(concat2, f7, "NCHW", "VALID", 2, 2)
...
def run(num_step, type, batch_size, gpu_num, file_name):
    record = record_GPU.record("InceptionV4", type, gpu_num, file_name)
    record.start()

    print("InceptionV4" + " type" + str(type) + " start")
    inception_v4 = Inceptionv4(num_step, type, batch_size, gpu_num, file_name)
    inception_v4.inception_v4()
    print("InceptionV4" + " type" + str(type) + " finish")
    record.stop()